                    ...
                    <div className="my-[50px]">
                        {
                            ...
                            state.map((item: any, index: number) => (
                                <div key={index} className="flex">
                                    <div className="w-[50%] border border-solid border-[#dedede] p-[12px] pb-[20px] text-center font-roboto text-[14px] leading-[50px] font-[400] text-[#666]" dangerouslySetInnerHTML={{ __html: item.date }} />
                                    <div className="w-[50%] border border-solid border-[#dedede] p-[12px] pb-[20px] text-end font-roboto text-[14px] leading-[50px] font-[400] text-[#666]" dangerouslySetInnerHTML={{ __html: item.description }} />
                                </div>
                            ))
                        }
                    </div>
