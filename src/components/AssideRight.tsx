            ...
            <BlockStyleds title={<span className="text-[#111111]">Архивы</span>}>
                {
                    ...
                    archive.map((item: any, index: number) => (
                        <p key={index} className="text-[14px] cursor-pointer text-[#111111] font-roboto font-[500] leading-[18px] hover:text-base_blue duration-200 mt-[11px]">{item.date}</p>
                    ))
                }
            </BlockStyleds>
            <BlockStyleds title={<span className="text-[#111111]">Рубрики</span>}>
                <hr className="mb-[20px] bg-[#ececec] h-[1px] border-none" />
                <Link to={`/news/search/Без категории`} className="mb-[13px] flex items-center justify-between cursor-pointer hover:text-base_blue text-[#111111] duration-200">
                ...
                <Link to={`/news/search/Новости`} className="mb-[13px] flex items-center justify-between cursor-pointer hover:text-base_blue text-[#111111] duration-200">
