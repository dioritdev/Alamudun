...
export function Share({ newsId, likes, unchangebl }: { newsId: number, likes: number, unchangebl: boolean }) {
    ...
    return (
        <div className="flex items-center flex-wrap gap-[9px] border border-solid border-[#dedede] py-[10px] px-[20px]">
            <p className="text-[#111111] font-[700] text-[14px] font-roboto leading-[16px]">Поделиться</p>
            <button className="text-[#111] font-[400] leading-[32px] font-roboto text-[14px] flex items-center gap-[7px] border border-solid border-[#dedede] px-[12px] rounded-[2px]" onClick={() => {
                if (!unchangebl) {
                    let token = localStorage.getItem('token')
                    fetch(`https://aodatka.pythonanywhere.com/api/v1/news/${newsId}/`, {
                        method: "PATCH",
                        headers: {
            ...
            <Link to="/" className="h-[32px] w-[32px] flex rounded-[2px] p-[8px] items-center justify-center bg-[#0d47a1]">
                <img src="/assets/svg/fc.svg" className="h-[100%] w-[100%] object-contain" />
            </Link>
            <Link to="/" className="h-[32px] w-[32px] flex rounded-[2px] p-[8px] items-center justify-center bg-[#40c4ff]">
                <img src="/assets/svg/tw.svg" className="h-[100%] w-[100%] object-contain" />
            </Link>
            <Link to="/" className="h-[32px] w-[32px] flex rounded-[2px] p-[8px] items-center justify-center bg-[#eb4026]">
                <img src="/assets/svg/google.svg" className="h-[100%] w-[100%] object-contain" />
            </Link>
            <Link to="/" className="h-[32px] w-[32px] flex rounded-[2px] p-[8px] items-center justify-center bg-[#C92228]">
                <img src="/assets/svg/pinterest.svg" className="h-[100%] w-[100%] object-contain" />
            </Link>
            <Link to="/" className="h-[32px] w-[32px] flex rounded-[2px] p-[8px] items-center justify-center bg-[#0077B5]">
                <img src="/assets/svg/in.svg" className="h-[100%] w-[100%] object-contain" />
            </Link>
            <Link to="/" className="h-[32px] w-[32px] flex rounded-[2px] p-[8px] items-center justify-center bg-[#34465d]">
                <img src="/assets/svg/tumblr.svg" className="h-[100%] w-[100%] object-contain" />
            </Link>
            <Link to="/" className="h-[32px] w-[32px] flex rounded-[2px] p-[8px] items-center justify-center bg-[#ff4500]">
                <img src="/assets/svg/reddit.svg" className="h-[100%] w-[100%] object-contain" />
            </Link>
            <Link to="/" className="h-[32px] w-[32px] flex rounded-[2px] p-[8px] items-center justify-center bg-[#179cde]">
                <img src="/assets/svg/tg.svg" className="h-[100%] w-[100%] object-contain" />
            </Link>
            <Link to="/" className="h-[32px] w-[32px] flex rounded-[2px] p-[8px] items-center justify-center bg-[#a7a7a7]">
                <img src="/assets/svg/envelop.svg" className="h-[100%] w-[100%] object-contain" />
            </Link>
        </div>
    )
}